...
system "/usr/local/bin/blast-2.2.18/bin/blastall  -p blastp -d /webservers/cgi-bin/lactamasedb/CBMAR_NEW/blaprotein/protein.fasta  -i $dir/input.fasta -e $evalue -T T -o $dir/test.html";
    system "/usr/bin/perl /webservers/cgi-bin/lactamasedb/aa.pl $dir/test.html >$dir/final.html"; 
}
if($database eq 'nucleotide')
{
system "/usr/local/bin/blast-2.2.18/bin/blastall  -p blastn -d /webservers/cgi-bin/lactamasedb/CBMAR_NEW/blanuc/nuc.fasta  -i $dir/input.fasta  -e $evalue  -T T -o $dir/test.html";
    system "/usr/bin/perl /webservers/cgi-bin/lactamasedb/aa.pl $dir/test.html >$dir/final.html";
}
if($database eq 'PDB')
{
...
system "/usr/local/bin/blast-2.2.18/bin/blastall  -p blastp -d /webservers/cgi-bin/lactamasedb/CBMAR_NEW/blapdb/pdb.fasta  -i $dir/input.fasta  -e $evalue -T T -o $dir/test.html";
system "/usr/bin/perl /webservers/cgi-bin/lactamasedb/aa.pl $dir/test.html >$dir/final.html";
