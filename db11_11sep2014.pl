...
foreach $field_no(@display_fields)
{
    ...
    {
	print OUT"<td align='center'  height='34'><font size='2' color='#0066FF' face='Times New Roman'>Inhibitor Susceptibility</font></td>\n";
    }
    if($field_no=~/Genus/)
    {
    ...
    {
	print OUT"<td align='center'  height='34'><font size='2' color='#0066FF' face='Times New Roman'>Hydroltic Profile</font></td>\n";
    }
...
while(my(@row)=$query_handle->fetchrow_array)
{
	...
	if($z == 2)
	{
	    ...
	    print OUT"<td align='center'><a href=\"../../../lactamasedb/$detail_name\" target=\"_blank\"><font size='2'>$row[$z]</font></a></td>";
